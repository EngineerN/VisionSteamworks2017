#include "GearGripPipeline.h"

namespace grip {

GearGripPipeline::GearGripPipeline() {
}
/**
* Runs an iteration of the pipeline and updates outputs.
*/
void GearGripPipeline::Process(cv::Mat& source0){
	//Step HSV_Threshold0:
	//input
 ...
 */
std::vector<std::vector<cv::Point> >* GearGripPipeline::GetFindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GearGripPipeline::GetFilterContoursOutput(){
	 ...
	 */
	void GearGripPipeline::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void GearGripPipeline::filterContours(std::vector<std::vector<cv::Point> > &inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight, double solidity[], double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, std::vector<std::vector<cv::Point> > &output) {
